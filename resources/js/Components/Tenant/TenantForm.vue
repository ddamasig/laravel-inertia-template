...
const form = useForm({
  ...
  pairing_bonus_enabled: props.tenant?.pairing_bonus_enabled ?? null,
  pairing_bonus_amount: props.tenant?.pairing_bonus_amount ?? null,
  pairing_bonus_max: props.tenant?.pairing_bonus_max ?? null,
  pairing_bonus_fifth_pairs_enabled: props.tenant?.pairing_bonus_fifth_pairs_enabled ?? null,
  flush_out_enabled: props.tenant?.flush_out_enabled ?? null,
  max_waiting_points: props.tenant?.max_waiting_points ?? null,
  infinity_bonus_enabled: props.tenant?.infinity_bonus_enabled ?? null,
  ...
  region_tagging_bonus_enabled: props.tenant?.region_tagging_bonus_enabled ?? null,
  ...
  ticketing_enabled: props.tenant?.ticketing_enabled ?? null,
